...
def start_processing():
    ...
    # You can adjust Decision Tree parameters based on your needs
    decision_tree = DecisionTreeClassifier(random_state=42)

    skf = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)

    # Perform cross-validation predictions
    cv_predictions = cross_val_predict(decision_tree, input_data, output_data, cv=skf)
...
# GUI Setup
root = tk.Tk()
root.title("Decision Tree Classifier GUI")
